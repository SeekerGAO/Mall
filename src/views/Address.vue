      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item, index) in addressListFilter" v-bind:class="{'check': checkIndex == index}" @click="selectAddress(index, item.addressId)">
                  <dl>
                    <dt>{{item.userName}}</dt>
                    <dd class="address">{{item.streetName}}</dd>
                    <dd class="tel">{{item.tell}}</dd>
                  </dl>
                  ...
                  <div class="addr-opration addr-set-default">
                    <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" @click="setDefalut(item.addressId)"><i>Set default</i></a>
                  </div>
          ...
          <div class="next-btn-wrap">
            <a href="javascript:;" class="btn btn--m btn--red" v-bind:class="{'btn--dis': checkIndex == 9999}" @click="skipNext">Next</a>
          </div>
        </div>
      </div>
    </div>
	...
	export default {
		...
		methods: {
		  // 获取地址列表
            ...
            //     }
            // }
            this.addressList.splice(indexOf, 1)
