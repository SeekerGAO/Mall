      ...
      <div class="container">
        <div class="checkout-addr">
              ...
              <ul>
                <li v-for="(item, index) in addressListFilter" v-bind:class="{'check': checkIndex == index}" @click="selectAddress(index, item.addressId)">
                  ...
                  <div class="addr-opration addr-set-default">
                    <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" @click="setDefalut(item.addressId)"><i>设为默认地址</i></a>
                  </div>
          ...
          <div class="next-btn-wrap">
            <a href="javascript:;" class="btn btn--m btn--red" v-bind:class="{'btn--dis': checkIndex == 9999}" @click="skipNext">下一步</a>
          </div>
        </div>
      </div>
    </div>
