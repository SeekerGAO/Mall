<template>
  <div>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-pic">
                    <img v-bind:src="'/static/' + item.productImg " v-bind:alt="item.productName ">
                  </div>
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="editCart('miuns', item)">-</a>
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;" @click="toggerCheckAll">
    ...
    <modal v-bind:mdShow="modalConfirm" @close="closeModal">
      <p slot="message">您确认删除商品吗？</p>
      <div slot="btnGroup">
        <a href="javascipt:;" class="btn btn--m" @click="delCart">确认</a>
        <a href="javascipt:;" class="btn btn--m" @click="modalConfirm = false">关闭</a>
      </div>
    </modal>
